  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "MSSQL"."FUNC_GETPRICE_COMPARE" 
( p_UNITID IN NUMBER,
p_DEBUG IN NUMBER
...
--  
  ...
  ----------
  ----------
  --lv_orderid, lv_linenumber,lv_itemid, p_UNITID, lv_optionid, lv_pricinggroupid, 
  --lv_fieldtypeid, lv_precondition, lv_prevalue, lv_baseprice, lv_optionprice + lv_optionprice_group,lv_pricingorderindex,lv_pricingoptionorderindex
