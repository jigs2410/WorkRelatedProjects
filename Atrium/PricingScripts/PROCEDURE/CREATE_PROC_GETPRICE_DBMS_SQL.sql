  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "MSSQL"."PROC_GETPRICE_DBMS_SQL" 
( p_UNITID IN NUMBER,
p_DEBUG IN NUMBER,
price OUT number
) IS
             ...
             -- parts NUMBER := hsashcount +  vsashcount;
                windows NUMBER := :73;      
                     ...
                     THEN
                         ...
                         SELECT ' || lv_prevalue || ',1 INTO :nbr_prevalue,:lv_return FROM DUAL;
                     
                    --  SELECT ' || lv_prevalue || ',1  FROM DUAL;
                      
                       ELSE
                          :lv_return := 0;
                      --    SELECT ' || lv_prevalue || ',0 INTO :nbr_prevalue,:lv_return FROM DUAL;
...
curret := DBMS_SQL.FETCH_ROWS(cur_hdl);
