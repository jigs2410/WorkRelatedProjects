...
wordDoc = Document('Template1-TestCases-Traceability.docx')
UCName=""
TestCase=""
wb = Workbook()
ws1 = wb.active
ws1.title = "Traceability"
ws1.cell(column=1, row=1, value="SYRSTO-ID")
ws1.cell(column=2, row=1, value="SYRS NUMBER")
ws1.cell(column=3, row=1, value="TEST CASE NUMBER") 
ws1.cell(column=4, row=1, value="DATA DICTIONARY RULE ID")
...
def writeToExcel(TO,EDList,TestCase):
    ...
    if TO in SYRS_TO:
        ...
        ws1.cell(column=3, row=excelRow, value=TestCase)
        
        # ED_ID's are more than one write it on different lines
        currentRow = excelRow
        for id in EDList:
            ws1.cell(column=4, row=currentRow, value=id)
            currentRow+=1
             ...
             for row in table.rows:
                if rowCount ==0:
                    ...
                    if (cells[0].text.strip(' \t\n\r') == "Name of Use Case"):
                        ...
                        targetFile = "Traceability_"+UCName+".xlsx"
        ...
        if tableCounter >= 3 and validDoc == 2: #Process Test Case
            ...
            for row in table.rows:
                ...
                if rowCount ==1:
                    ...
                    ruleIDHeader = cells[5].text.strip(' \t\n\r')
